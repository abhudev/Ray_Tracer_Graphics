...
Quadric::Quadric(const mat4d& m): Object("Quadric"), id(obj_count++), mat(m) {}

bool Quadric::internal_intersect(Ray& r, double& t, int& args){
...
bool Quadric::internal_get_normal(Point& p, Ray& r, int& args){
...
bool Quadric::get_mesh(std::ofstream& fout) {
    return true;
}